...
// The "this" is the object created with the Student constructor function- in this case, the joe object
// 2. What is "this" when joe.scopeArrow() is invoked?
// The "this" is the global window object
// 3. Explain why "this" is different when an arrow function is used.
// The "this" context stays the same as whatever it was before the arrow function begins running. So if the "this" outside the function is a certain object- it will refer to that. But if there is nothing outside the arrow function, the "this" will refer to the current browser window. 
